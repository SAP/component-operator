...
type ComponentIndexInformer cache.TypedSharedIndexInformer[*apiscorecssapcomv1alpha1.Component]

// ComponentHandlerFuncs is a specialization of [cache.TypedResourceEventHandlerFuncs] for Component.
type ComponentHandlerFuncs = cache.TypedResourceEventHandlerFuncs[*apiscorecssapcomv1alpha1.Component]

// ComponentDetailedHandlerFuncs is a specialization of [cache.TypedResourceEventHandlerDetailedFuncs] for Component.
type ComponentDetailedHandlerFuncs = cache.TypedResourceEventHandlerDetailedFuncs[*apiscorecssapcomv1alpha1.Component]

// ComponentFilteringHandler is a specialization of [cache.TypedFilteringResourceEventHandler] for Component.
type ComponentFilteringHandler = cache.TypedFilteringResourceEventHandler[*apiscorecssapcomv1alpha1.Component]

// ComponentIndexers is a specialization of [cache.TypedIndexers] for Component.
type ComponentIndexers = cache.TypedIndexers[*apiscorecssapcomv1alpha1.Component]

// DeletedComponent is a specialization of [cache.DeletedObject] for Component.
type DeletedComponent = cache.DeletedObject[*apiscorecssapcomv1alpha1.Component]
...
func NewTypedComponentInformerWithOptions(client versioned.Interface, namespace string, options internalinterfaces.InformerOptions) ComponentIndexInformer {
	...
	return cache.NewTypedSharedIndexInformer[*apiscorecssapcomv1alpha1.Component](cache.NewSharedIndexInformerWithOptions(
...
func (f *componentInformer) TypedInformer() ComponentIndexInformer {
	return cache.NewTypedSharedIndexInformer[*apiscorecssapcomv1alpha1.Component](f.factory.InformerFor(&apiscorecssapcomv1alpha1.Component{}, f.defaultInformer))
}
...
func (a *componentTypedInformerAdapter) TypedInformer() ComponentIndexInformer {
	return cache.NewTypedSharedIndexInformer[*apiscorecssapcomv1alpha1.Component](a.Informer())
}
...
func ToComponentIndexInformer(informer cache.SharedIndexInformer) ComponentIndexInformer {
	...
	return cache.NewTypedSharedIndexInformer[*apiscorecssapcomv1alpha1.Component](informer)
}
