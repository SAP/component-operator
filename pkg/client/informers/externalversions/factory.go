...
import (
	...
	corecssapcom "github.com/sap/component-operator/pkg/client/informers/externalversions/core.cs.sap.com"
...
type SharedInformerFactory interface {
	...
	Core() corecssapcom.Interface
}

func (f *sharedInformerFactory) Core() corecssapcom.Interface {
	return corecssapcom.New(f, f.namespace, f.tweakListOptions)
}
