...
require (
	...
	github.com/sap/component-operator-runtime v0.3.131
	github.com/sap/go-generics v0.2.52
	...
	sigs.k8s.io/controller-runtime/tools/setup-envtest v0.0.0-20260215011159-80d56e741406
